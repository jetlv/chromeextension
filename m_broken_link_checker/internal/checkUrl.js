...
function checkUrl(link, baseUrl, cache, options, retry) {
    //2017-03-29 --Fixed special character issue
    link.url.resolved = link.url.resolved.replace(/–/g, '%E2%80%93');
    var cached;
    ...
    var request = bhttp.request(link.url.resolved,  // TODO :: https://github.com/joepie91/node-bhttp/issues/3
        ...
        .then(function (response) {
            // if(link.url.resolved == 'https://seomelbourne.com/wp-content/uploads/2013/05/What-Are-Exact-Match-Domains-–-What-AreThe-Pros-and-The-Cons-758x426.png') {
            // 	console.log('debug');
            // }
